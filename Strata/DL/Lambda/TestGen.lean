          ...
          [(1,
            ...
            (1, do
                ...
                if x.snd = ty_1 then do
                  let m ← Arbitrary.arbitrary
                  return Lambda.LExpr.fvar m x.fst (.some <| LTy.toMonoTypeUnsafe ty_1)
                else
...
#eval LExpr.varClose (T := trivialParams) 0 ("x", none) (.fvar () "x" (.some <| LMonoTy.tcons "bool" []))
